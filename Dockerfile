...
ENV MARK="9.2.1"
RUN apt-get update \
&& apt-get install --no-install-recommends -qq ca-certificates bash software-properties-common \
&& add-apt-repository ppa:deadsnakes/ppa && apt-get install python3.9 \
&& apt-get clean \
